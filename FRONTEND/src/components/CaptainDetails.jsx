        ...
        <div className='absolute bg-white bottom-2 w-full p-3 rounded-t-lg  '>
          <div className='flex items-center justify-between'>
            <div className='flex items-center justify-start gap-4'>
              <img className='h-14 w-14 rounded-full object-cover' src='https://img.buzzfeed.com/buzzfeed-static/static/2016-04/25/10/enhanced/webdr06/original-30465-1461593533-10.jpg?fill=625:625'></img>
              <h4 className='text-lg font-semibold text-gray-800'>Bhavy Patel</h4>
            </div>
              <div>
                <h4>₹295.5</h4>   
                <p>Earned</p>
